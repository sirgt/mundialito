...
class PredictionsControllerTest < ActionController::TestCase
  ...
  test "should create prediction" do
    assert_difference('Prediction.count') do
      post :create, prediction: { match: @prediction.match, score_a: @prediction.score_a, score_b: @prediction.score_b, user_id: @prediction.user_id }
    end
  ...
  test "should update prediction" do
    patch :update, id: @prediction, prediction: { match: @prediction.match, score_a: @prediction.score_a, score_b: @prediction.score_b, user_id: @prediction.user_id }
    assert_redirected_to prediction_path(assigns(:prediction))
  end
